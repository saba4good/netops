...
if __name__ == '__main__':
    ...
    parser.add_argument('dns_req_file', type=argparse.FileType('r', encoding='UTF-8'))  ### https://stackoverflow.com/questions/20994352/unicodeencodeerror-cp949-codec-cant-encode-character-u20a9-in-position-90
